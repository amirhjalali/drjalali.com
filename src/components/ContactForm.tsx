...
const ContactForm = () => {
  ...
  return (
    <section id="contact" className="py-24 md:py-28 bg-white dark:bg-neutral-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-neutral-100 mb-8 font-playfair">Contact</h2>
        </div>
