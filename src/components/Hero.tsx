  ...
  return (
    <section className="relative pt-16 bg-gradient-to-br from-primary-50 via-white to-blue-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900 overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute inset-0 opacity-5 dark:opacity-10">
        ...
        <div className="absolute -bottom-32 left-20 w-80 h-80 bg-blue-200 dark:bg-blue-700 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-2xl opacity-60 motion-safe:animate-pulse motion-safe:delay-500"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-28 pb-24 sm:pb-32 lg:pb-40 z-10">
        ...
        <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          {/* Content */}
          <div className={`transform motion-safe:transition-all motion-safe:duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            <div className="space-y-6">
              <h1 className="heading-primary text-fluid-5xl font-playfair">
              ...
              <p className="body-large text-fluid-xl text-gray-700 dark:text-neutral-200 max-w-[60ch]">
            ...
            <div className={`mt-10 flex flex-row gap-4 transform motion-safe:transition-all motion-safe:duration-700 motion-safe:delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
              <Button
                href="#about"
                variant="primary"
                size="lg"
          ...
          <div className={`flex justify-end transform motion-safe:transition-all motion-safe:duration-1000 motion-safe:delay-200 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            <div className="relative group">
              ...
              <div className="relative w-[28rem] h-[28rem] shadow-2xl ring-4 ring-white dark:ring-neutral-700 ring-opacity-60 dark:ring-opacity-70 group-hover:ring-opacity-80 dark:group-hover:ring-opacity-90 motion-safe:transition-all motion-safe:duration-500 transform group-hover:scale-105 rounded-full overflow-hidden">
                <ProfessionalPhoto 
        ...
        <div className="lg:hidden">
          {/* Mobile Content */}
          <div className={`text-center transform motion-safe:transition-all motion-safe:duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          ...
          {/* Mobile Photo */}
          <div className={`flex justify-center mt-8 transform motion-safe:transition-all motion-safe:duration-1000 motion-safe:delay-200 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            <div className="relative group">
              ...
              <div className="relative w-80 h-80 shadow-2xl ring-4 ring-white dark:ring-neutral-700 ring-opacity-60 dark:ring-opacity-70 group-hover:ring-opacity-80 dark:group-hover:ring-opacity-90 motion-safe:transition-all motion-safe:duration-500 transform group-hover:scale-105 rounded-full overflow-hidden">
                <ProfessionalPhoto 
                  src="/images/professional/dr-jalali-professional.png"
                  className="w-full h-full"
                  alt="Dr. Ali Akbar Jalali - Professor of Electrical Engineering"
              ...
              <a href="#academic" className="absolute -top-6 left-2 bg-white dark:bg-neutral-800 rounded-lg px-3 py-2 shadow-xl border border-gray-100 dark:border-neutral-700 transform rotate-2 hover:rotate-0 motion-safe:transition-all motion-safe:duration-300 hover:scale-105 cursor-pointer">
                <div className="text-center">
                  <div className="text-primary-600 dark:text-primary-400 text-lg font-bold">30+</div>
                  <div className="text-xs font-medium text-gray-600 dark:text-neutral-200">Years</div>
                </div>
              </a>
              
              <a href="#research" className="absolute -bottom-4 -right-6 bg-white dark:bg-neutral-800 rounded-lg px-3 py-2 shadow-xl border border-gray-100 dark:border-neutral-700 transform -rotate-2 hover:rotate-0 motion-safe:transition-all motion-safe:duration-300 hover:scale-105 cursor-pointer">
                <div className="text-center">
                  <div className="text-primary-600 dark:text-primary-400 text-lg font-bold">300+</div>
                  <div className="text-xs font-medium text-gray-600 dark:text-neutral-200">Papers</div>
                </div>
              </a>
              
              <a href="#research" className="absolute top-16 -left-8 bg-white dark:bg-neutral-800 rounded-lg px-3 py-2 shadow-xl border border-gray-100 dark:border-neutral-700 transform rotate-3 hover:rotate-0 motion-safe:transition-all motion-safe:duration-300 hover:scale-105 cursor-pointer">
                <div className="text-center">
                  <div className="text-primary-600 dark:text-primary-400 text-lg font-bold">50+</div>
                  <div className="text-xs font-medium text-gray-600 dark:text-neutral-200">Books</div>
                </div>
              </a>
              
              <a href="#about" className="absolute bottom-14 right-2 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-lg px-3 py-2 shadow-xl transform -rotate-1 hover:rotate-0 motion-safe:transition-all motion-safe:duration-300 hover:scale-105 cursor-pointer">
          ...
          <div className={`mt-8 text-center transform motion-safe:transition-all motion-safe:duration-1000 motion-safe:delay-400 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
            <p className="body-large text-fluid-lg text-gray-700 dark:text-neutral-200 mb-6 px-4 max-w-[60ch] mx-auto">
              Professor of Electrical Engineering at Iran University of Science and Technology. 
              Pioneer in Internet of Things, Control Systems, and Information Technology with 
              over 30 years of academic excellence and 300+ published papers.
            </p>
          ...
          <div className={`mt-10 flex flex-col gap-4 px-4 transform motion-safe:transition-all motion-safe:duration-700 motion-safe:delay-600 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            <Button
              href="#about"
              variant="primary"
              size="lg"
